...
class StatsAPIView(APIView):
    ...
    def get(self, request):
        ...
        if stats:
            ...
            return Response({"error": "No data found for these criteria."}, status=status.HTTP_404_NOT_FOUND)
    ...
    def post(self, request):
        ...
        try:
            ...
            if resp.status_code == 200:
                ...
                return Response({"error": "Failed to fetch ad from BienIci API"}, status=status.HTTP_502_BAD_GATEWAY)
