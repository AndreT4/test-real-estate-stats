...
class RealEstateAdAPITests(APITestCase):
    def setUp(self):
        self.ad1 = RealEstateAd.objects.create(reference='REF001', city='Paris', zip_code='75001', department='75', co_ownership_charges=100)
        self.ad2 = RealEstateAd.objects.create(reference='REF002', city='Lyon', zip_code='69001', department='69', co_ownership_charges=200)
